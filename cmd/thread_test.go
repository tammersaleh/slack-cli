...
func TestThreadList_MockAPI(t *testing.T) {
	...
	// Each reply should carry channel_id so agents can construct follow-ups.
	if parent["channel_id"] != "C01ABC" {
		t.Errorf("expected channel_id='C01ABC', got %q", parent["channel_id"])
	}
}
